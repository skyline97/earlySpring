...
public class TestEarlySpring {
	...
	public void testBeanPostProcessor() throws Exception {
		...
		//addBeanPostProcessor必须在loadBeanDefinition之前,
		//否则对lazyInit属性为false的bean无效
	...
	public void testAop01() throws Exception {
		...
		TargetSource targetSource = new TargetSource(Address.class,
				Address.class.getInterfaces(), address);
	...
	public void testProxyFactory() throws Exception {
		...
		AInterface proxy = (AInterface) ((AopProxy) proxyFactory.getProxy())
				.getProxy();
		proxy.log();
	}
